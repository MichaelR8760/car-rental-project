...
try {
    ...
    $updateQuery = "UPDATE customer_details SET stripe_customer_id = :stripe_id WHERE user_id = :user_id";
    $updateStmt = $db->prepare($updateQuery);
    $updateStmt->bindParam(':stripe_id', $customer->id);
    ...
    $checkout_session = \Stripe\Checkout\Session::create([
        ...
        'success_url' => 'http://localhost/stripe_success.php',
