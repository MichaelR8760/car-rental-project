...
5. Deploy to PHP enabled web server
6. Ensure proper file permissions for upload directories

## Deployment

This application is deployed on AWS Elastic Beanstalk.

Live URL: http://revlink-car-rental-env.eba-mbg8tbdm.us-east-1.elasticbeanstalk.com
